...
import { faArrowLeft, faLock, faCircleCheck } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="auth-page-container">
      <div className="auth-card">
        <div className="illustration-circle">
          <FontAwesomeIcon icon={faLock} className="main-icon" />        </div>
        <h1>{t('forgot_pass?')}</h1>
        ...
        <form className="auth-form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button type="submit" className="btn-primary" disabled={isLoading}>{buttonText}</button>
